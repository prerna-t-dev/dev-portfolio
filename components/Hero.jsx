  ...
  return (
    <div id="pf--hero" className="lg:text-center max-w-[1260px] mx-auto min-h-[50vh] lg:min-h-[80vh] bg-secondary-300_ mt-12 lg:mt-32 px-6">
        ...
        <motion.p
          ...
          className="text-lg lg:text-2xl font-medium text-secondary-500 leading-[1.25em] md:leading-[1.08em] lg:px-[400px]"
        >
         Senior Shopify Plus Engineer | Technical Partner to Growing D2C Brands
        </motion.p>
        ...
        <motion.p
          ...
          animate={{ opacity: 0.7 }}
          transition={{ duration: 1.5, delay: 0.5 }}
          className="text-sm lg:text-xl font-medium text-secondary-500 text-white leading-[1.25em] md:leading-[1.08em] px-30 lg:px-[350px] mt-10"
        >
